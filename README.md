...
|F13|0x68|0x32|Mute Speaker (Fn + F1)|
|F14|0x69|0x33|Decrement Volume (Fn + F2)|
|F15|0x6A|0x30|Increment Volume (Fn + F3)|
|F16|0x6B|0x31|Mute Mic (Fn + F4)|
|F17|0x6C|0x36|Darken Screen (Fn + F5)|
|F18|0x6D|0x37|Brighten Screen (Fn + F6)|
|F19|0x6E|0x34|Switch Screen (Fn + F7)|
|F20|0x6F|0x35|Toggle Wi-fi (Fn + F8)|
|F21|0x70|0x2a|Open Setting (Fn + F9)|
|F22|0x71|0x2b|Open Search (Fn + F10)|
|F23|0x72|0x28|View Open Apps (Fn + F11)|
|F24|0x73|0x29|Open My Computer (Fn + F12)|
