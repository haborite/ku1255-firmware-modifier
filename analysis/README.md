# About
This is a keymap for the Lenovo KU-1255 (ThinkPad Compact USB Keyboard with TrackPoint) firmware installer. The firmware installer stores key-specific values, generated by XORing the HID Usage ID with 0x5A, at specific offsets within the binary.
...
| ID | Address | XORed_ID | Usage Name | 0B47190 (ANSI/US) | 0B47208 (JIS/JP) | 0B47192 (ISO/UK) |
| --- | --- | --- | --- | --- | --- | --- |
| 00 |  | 5A | No Event |  |  |  |
| 01 |  | 5B | ErrorRollOver |  |  |  |
| 02 |  | 58 | POSTFail |  |  |  |
